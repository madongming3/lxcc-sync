...
#标记robot的信息数据
define('ROBOT_SERVER_TABLE',          'sync_robot_s');
define('DB_ROBOT_ID',                 'id');
define('DB_ROBOT_DESC',               'nrobot');
define('DB_ROBOT_IP',                 'r_ip');
define('DB_ROBOT_PORT',               'r_port');
define('DB_ROBOT_PATH',               'r_path');
define('DB_ROBOT_USER',               'r_user');
define('DB_ROBOT_PASSWD',               'r_passwd');
define('DB_ROBOT_DEL',               'r_del');


define('ROBOT_INFO_KEY_DESC',           'nrobot');
define('ROBOT_INFO_KEY_ID',       'id');
define('ROBOT_INFO_KEY_IP',       'ip');
define('ROBOT_INFO_KEY_PORT',     'port');
define('ROBOT_INFO_KEY_USERNAME', 'username');
define('ROBOT_INFO_KEY_PASSWORD', 'password');
define('ROBOT_INFO_KEY_WWWROOT',  'wwwroot');
define('ROBOT_KEY_CLOSE', 'is_del');

#robot查询结果列表
define('ROBOT_TABLE_NAME',         'test_result');
define('ROBOT_RUN_PASSRATE',       'passrate');
define('ROBOT_RUN_SYNC',           'syncid');


#操作时间到中文解释的对应关系
define('OP_TYPE_ROLLBACK',              'rollback_time');
define('OP_TYPE_SYNC_TIME',             'sync_time');
define('OP_TYPE_SUBTEST_TIME',          'submit_test');
define('OP_TYPE_ROBOT_TIME',            'robot_test');
define('OP_TYPE_MODIFY_TIME',           'modify_time');
define('OP_TYPE_DEL_TIME',              'del_time');
define('OP_TYPE_CREATE_TIME',           'create_time');
define('OP_TYPE_PASS_TIME',             'test_pass');
define('OP_TYPE_FAILED_TIME',           'test_failed');
#sync_servers表字段定义
...
define('DB_USERS_MAIL',                 's_mail');
define('DB_USERS_GROUP',                's_group');
...
define('DB_SECTION_JENKINS',            's_jenkins');
define('DB_SECTION_OP_LIST',            's_op_list');
define('DB_SECTION_TRAC_ID',            's_trac_id');
define('DB_SECTION_OWNER',              's_owner');
define('DB_SECTION_STATUS',             'test_status');
define('DB_SECTION_PASSRATE',           'pass_rate');
define('DB_SECTION_ROBOTPATH',          's_robot_path');
#数据库操作历史记录的key的值

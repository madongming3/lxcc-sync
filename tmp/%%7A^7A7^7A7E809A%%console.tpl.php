<?php /* Smarty version 2.6.26, created on 2016-11-03 18:40:08
         compiled from console/console.tpl */ ?>
...
<!--中间-->
    ...
    <!--欢迎-->
        ...
        <!--左侧菜单-->
        <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "console/left_menu.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
            <div class="rightContent">
                ...
                <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "console/console_nav.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
                <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?>
<script type="text/javascript" src="/static/<?php echo @CURR_MOD; ?>
.js"></script>
<?php $_smarty_tpl_vars = $this->_tpl_vars;

...
define('WT_STATUS','status');
define('WT_PASS',   'pass_rate');
define('WT_PATH',   'robot_path');

define('WT_EM',    'errmsg');
define('SYNC_SVN_LOG_MAX',          10);

define('JK_PROJECT',    'pro_name');
define('JK_USER',    'cr_user');
define('JK_STATUS','status');
define('JK_DATE',   'cr_time');
define('JK_INFO',   'jenkins');

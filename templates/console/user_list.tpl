                    <table border="0" class="table table-bordered table-striped projectTable">
						...
						<tr class="trTitle">
						    ...
						    <td width="140" height="30" align="center"><span class="STYLE1">所属项目</span></td>
							<td width="130" height="30" align="center"><span class="STYLE1">用户权限</span></td>
                        ...
                        <tr {if $item[$smarty.const.DB_USERS_DEL] == $smarty.const.USER_DEL_YES}style="color:#f00;"{/if}>
                            ...
                            <td width="170" height="30" align="center">{$item[$smarty.const.DB_USERS_GROUP]|escape}</td>

...
{elseif $smarty.const.CURR_MOD == 'console/robot'}
	<h2>robot服务器管路
		<a href="{$smarty.const.ROBOT_ACTION_ROBOT}" style="margin-right:4px;" {if $smarty.const.CURR_ACT == 'index' || $smarty.const.CURR_ACT == 'create'} class="Cur"{/if}>新增</a>/
		<a href="{$smarty.const.ROBOT_ACTION_LIST}" style="margin-left:4px;" {if $smarty.const.CURR_ACT == 'list'} class="Cur"{/if}>列表</a>
	</h2>
